...
class ValidateUrlRequestSyntaxOnly(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """ValidateUrlRequestSyntaxOnly - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ValidateUrlRequestSyntaxOnly, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateUrlRequestSyntaxOnly):
            return False
