...
class VatLookupRequest(object):
    ...
    def __init__(self, vat_code=None):  # noqa: E501
        """VatLookupRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VatLookupRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VatLookupRequest):
            return False
