...
class DomainApi(object):
    ...
    def domain_is_admin_path(self, value, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str value: URL or relative path to check, e.g. \"/admin/login\".  The input is a string so be sure to enclose it in double-quotes. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.domain_is_admin_path_with_http_info(value, **kwargs)  # noqa: E501
        else:
            (data) = self.domain_is_admin_path_with_http_info(value, **kwargs)  # noqa: E501
            return data
    ...
    def domain_is_admin_path_with_http_info(self, value, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method domain_is_admin_path" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('value' not in params or
            ...
            raise ValueError("Missing the required parameter `value` when calling `domain_is_admin_path`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='IsAdminPathResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def domain_url_html_ssrf_check(self, request, **kwargs):  # noqa: E501
        """Check a URL for HTML embedded SSRF threats  # noqa: E501

        Checks if an input URL HTML is at risk of containing one or more embedded SSRF (Server-side request forgery) threats or attacks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domain_url_html_ssrf_check(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UrlHtmlSsrfRequestFull request: Input URL request (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.domain_url_html_ssrf_check_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.domain_url_html_ssrf_check_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def domain_url_html_ssrf_check_with_http_info(self, request, **kwargs):  # noqa: E501
        """Check a URL for HTML embedded SSRF threats  # noqa: E501

        Checks if an input URL HTML is at risk of containing one or more embedded SSRF (Server-side request forgery) threats or attacks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domain_url_html_ssrf_check_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method domain_url_html_ssrf_check" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'request' is set
        if ('request' not in params or
                params['request'] is None):
            raise ValueError("Missing the required parameter `request` when calling `domain_url_html_ssrf_check`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='UrlHtmlSsrfResponseFull',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
